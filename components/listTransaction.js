...
class ListTransaction extends Component {
    ...
    render() {
        ...
        let ProductView = NewData.map((product,i)=>{
            return(
                <div key={i.toString()} className={this.state.twoDiv}>
                    <Link as={'/productdetails/'+product.product_code} href={'/productdetails/[Pcode]'}>
                        <div className='product-card mb-0'>
                            <Image src={product.product_icon} className='product-img' alt='image'/>
                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-4 text-center'>
                                <Image className='cart-image' src={List.product_icon} alt='image'/>
                            </div>
                            <div className='col-4 text-center'>
